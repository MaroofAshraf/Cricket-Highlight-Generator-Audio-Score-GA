...
class GenerateVideo(QThread):
     ...
     def Gen_video(self,bestone):  
        ...
        for i,j in enumerate( highlight_list):
            ...
            sb.call("C:\\ffmpeg\\ffmpeg.exe -i " + j + " -s hd720 -r 30000/1001 -video_track_timescale 30k -c:a copy Save_Video_Clips/" + str(i) + ".mp4", startupinfo=si)
        ...
        if os.path.isdir('./FinalVideo'):
            ...
            sb.call("C:\\ffmpeg\\ffmpeg.exe -f concat -safe 0 -i Smooth_file.txt -c copy  "+path_video, startupinfo=si)
