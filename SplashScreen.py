...
"border-style:none;")
        ...
        self.cricket_frame.setStyleSheet("image: url(:/images/cricket.png);border: 0px;border-style: none;")
        ...
        self.frame.setStyleSheet("image:url(:/images/cricket.png);border: 0px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Cricket Highlight Generator"))
        self.label_3.setText(_translate("MainWindow", "Developed by : MAROOF ASHRAF"))
        self.label_2.setText(_translate("MainWindow", "Initializing Cricket Highlight Generator..."))
